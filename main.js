...
document.body.appendChild( renderer.domElement ); //adds the dom element that renders the model.
...
if ( WebGL.isWebGLAvailable() ) {
    ...
    function animate() {        // this is the render/animation loop, without it notwhing will render.
